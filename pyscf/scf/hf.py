...
Keyword argument "init_dm" is replaced by "dm0"''')
    ...
    for cycle in range(mf.max_cycle):
        ...
        #dm = new_function_that_does_d_diis(dm)
        if hasattr(mf_diis, "density_diis"):
            dm = mf_diis.update(s1e, dm, fock, h1e)
